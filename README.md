...
안녕하세요. 
저는 여러 파이썬 라이브러리를 이용해 디스코드 봇을 개발하고 있습니다. 

현재는 **AI 대화** 기능과 **음악 스트리밍** 기능을 위주로 봇을 관리하고 업데이트 중입니다.

> [!NOTE]
> 무료 서버를 이용중에 있어 봇이 예상치 못하게 꺼질 수 있습니다. 하지만 사용에 있어서 어쩔 수 없이 수집해야 하는 데이터는 안전하게 보관됩니다.
...
<table align="center" style="border: none;">
  <tr>
    <td align="center" width="50%" valign="top">
      ...
      <div align="left">
        <ul>
          <li>🤖 <b>자연스러운 대화:</b> AI 챗봇과의 스마트한 상호작용</li>
          <li>💡 <b>간편한 기능:</b> 직관적이고 편리한 사용자 경험 제공</li>
        </ul>
      </div>
    </td>
    <td align="center" width="50%" valign="top">
